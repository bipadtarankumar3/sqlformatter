...
import { Calendar, Clock, ChevronLeft, BookOpen, User, Check, Copy } from 'lucide-react';
import toast from 'react-hot-toast';

export default function BlogPostDetail({ params: paramsPromise }) {
  ...
  // Retrieve post
  useEffect(() => {
    const activePost = blogPosts.find((p) => p.slug === slug);
    if (activePost) {
      setPost(activePost);
    }
  }, [slug]);
